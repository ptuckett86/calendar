...
class Common(Configuration):
    ...
    REST_FRAMEWORK = {
        "DEFAULT_PAGINATION_CLASS": "calendar_events.core.pagination.CustomPagination",
        "PAGE_SIZE": 10,
    ...
    JWT_AUTH = {
        ...
        "JWT_RESPONSE_PAYLOAD_HANDLER": "calendar_events.core.jwt_overrides.jwt_response_payload_handler",
